    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ minHeight: 'calc(100vh - 66px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40, position: 'relative' }}>
        ...
        <div style={{ width: '100%', maxWidth: 420, background: '#151515', border: '1px solid #2a2a2a', borderRadius: 20, padding: 44, position: 'relative', zIndex: 2 }}>
          ...
          <div style={{ width: 56, height: 56, background: 'rgba(191,255,0,0.1)', border: '1px solid rgba(191,255,0,0.2)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, margin: '0 auto 20px' }}>🔑</div>
          ...
          {err && <div style={{ background: 'rgba(255,68,68,0.08)', border: '1px solid rgba(255,68,68,0.2)', borderRadius: 8, padding: '10px 14px', color: '#FF4444', fontSize: 13, marginBottom: 16 }}>⚠ {err}</div>}
          {success && <div style={{ background: 'rgba(0,255,127,0.08)', border: '1px solid rgba(0,255,127,0.25)', borderRadius: 8, padding: '10px 14px', color: '#00FF7F', fontSize: 13, marginBottom: 16 }}>✓ {success}</div>}
