      ...
      <div className="card" style={{ padding: 0 }}>
        ...
        {notifs.map((n, i) => (
          <div key={n.id} style={{
            ...
            background: !n.is_read ? 'rgba(255,68,68,.03)' : 'transparent',
          }}>
            <div style={{
              width: 38, height: 38, borderRadius: 10, flexShrink: 0,
              background: !n.is_read ? 'rgba(255,68,68,.1)' : 'rgba(255,255,255,.05)',
              border: `1px solid ${!n.is_read ? 'rgba(255,68,68,.2)' : 'rgba(255,255,255,.08)'}`,
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                ...
                {!n.is_read && (
                  <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#FF4444', flexShrink: 0, display: 'inline-block' }} />
                )}
              </div>
