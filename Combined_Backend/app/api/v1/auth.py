...
async def register(
    ...
    user_role = user_data.role if user_data.role in ['student', 'instructor', 'admin'] else 'student'
    
    logger.info(f"Creating user with: email={user_data.email}, full_name={user_data.full_name}, role={user_role}")
