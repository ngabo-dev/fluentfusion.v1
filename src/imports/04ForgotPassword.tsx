...
export default function Component04ForgotPassword() {
  ...
  return (
    <div className="bg-[var(--bg-primary)] content-stretch flex flex-col isolate items-start pointer-events-auto relative size-full" data-name="04-forgot-password">
      <div className="absolute bg-[var(--bg-secondary)] bottom-[16px] content-stretch flex flex-col items-start px-[11px] py-[6px] right-[17px] rounded-[6px] z-[3]" data-name="Background+Border">
        <div aria-hidden="true" className="absolute border border-[var(--border-subtle)] border-solid inset-0 pointer-events-none rounded-[6px]" />
      ...
      <div className="min-h-[834px] pointer-events-auto relative shrink-0 w-full z-[10]" data-name="Container">
        <div className="flex flex-row items-center justify-center min-h-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-h-[inherit] pb-[124.62px] pt-[124.63px] px-[40px] relative w-full">
            ...
            <div className="bg-[var(--bg-secondary)] content-stretch flex flex-col gap-[28px] items-center max-w-[420px] pb-[45.01px] pt-[44px] px-[45px] relative rounded-[20px] shrink-0 w-[420px]" data-name="Background+Border">
              ...
              <div className="relative shrink-0 w-full" data-name="Link">
                <button onClick={() => navigate('/login')} className="cursor-pointer bg-transparent border-none text-left w-full">
                  <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pb-[0.8px] relative w-full">
                    <div className="flex flex-[1_0_0] flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px relative text-[var(--text-tertiary)] text-[13px] hover:text-[var(--text-primary)] transition-colors" style={{ fontVariationSettings: "'opsz' 9" }}>
                      <p className="leading-[20.8px] whitespace-pre-wrap">← Back to Login</p>
                    </div>
                  </div>
                </button>
              </div>
              <div className="bg-[rgba(var(--accent-primary-rgb),0.1)] h-[59.195px] relative rounded-[32px] shrink-0 w-[64px]" data-name="Overlay+Border">
                <div aria-hidden="true" className="absolute border border-[rgba(var(--accent-primary-rgb),0.2)] border-solid inset-0 pointer-events-none rounded-[32px]" />
              ...
              <div className="relative shrink-0 w-full" data-name="Container">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative w-full">
                  <div className="content-stretch flex flex-col items-center pb-[0.585px] relative shrink-0 w-full" data-name="Container">
                    <div className="flex flex-col font-['Syne:ExtraBold',sans-serif] font-extrabold justify-center leading-[38.4px] relative shrink-0 text-[24px] text-center text-[var(--text-primary)] tracking-[-0.48px] uppercase whitespace-nowrap">
                      <p className="mb-0">Forgot</p>
                      <p>Password</p>
                    </div>
                  </div>
                  <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
                    <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[22.4px] relative shrink-0 text-[var(--text-tertiary)] text-[14px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
              ...
              <div className="relative shrink-0 w-full" data-name="Container">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[7px] items-start pb-[6px] relative w-full">
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Label">
                    <div className="flex flex-col font-['JetBrains_Mono:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[var(--text-tertiary)] text-[10px] tracking-[1px] uppercase w-full">
                      <p className="leading-[16px] whitespace-pre-wrap">Email Address</p>
                    </div>
                  </div>
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
                    <div className="bg-[var(--bg-tertiary)] relative rounded-[8px] shrink-0 w-full z-[10]" data-name="Input">
                        ...
                        <div className="content-stretch flex items-start justify-center pl-[45px] pr-[17px] py-[13px] relative w-full">
                          <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Container">
                            <input
                              ...
                              className="w-full bg-transparent border-none outline-none text-[var(--text-primary)] text-[15px] font-['DM_Sans:9pt_Regular'] placeholder:text-[var(--text-tertiary)]"
                            />
                          </div>
                        </div>
                      </div>
                      <div aria-hidden="true" className="absolute border border-[var(--border-subtle)] border-solid inset-0 pointer-events-none rounded-[8px]" />
                    </div>
                    <div className="absolute bottom-[22.17%] content-stretch flex flex-col items-start left-[14px] top-[22.2%]" data-name="Container">
                      <div className="flex flex-col font-['Noto_Color_Emoji:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[var(--text-tertiary)] text-[16px] whitespace-nowrap">
              ...
              {error && (
                <div className="bg-[rgba(var(--color-danger-rgb),0.1)] border border-[var(--color-danger)] px-[12px] py-[8px] rounded-[8px] w-full">
                  <p className="text-[var(--color-danger)] text-[13px] text-center">{error}</p>
                </div>
              )}
              {message && (
                <div className="bg-[rgba(var(--color-success-rgb),0.1)] border border-[var(--color-success)] px-[12px] py-[8px] rounded-[8px] w-full">
                  <p className="text-[var(--color-success)] text-[13px] text-center">{message}</p>
                </div>
              )}
              <div className="bg-[var(--accent-primary)] relative rounded-[10px] shadow-[0px_0px_12px_0px_rgba(var(--accent-primary-rgb),0.25)] shrink-0 w-full z-[20] cursor-pointer" data-name="Button" onClick={handleSubmit}>
              ...
              <div className="relative shrink-0 w-full" data-name="Container">
                <button onClick={() => navigate('/login')} className="cursor-pointer bg-transparent border-none text-center w-full">
                  <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative w-full">
                    <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[var(--text-tertiary)] text-[14px] text-center whitespace-nowrap hover:text-[var(--accent-primary)] transition-colors" style={{ fontVariationSettings: "'opsz' 9" }}>
                      <p>
                        <span className="leading-[22.4px]">{`Remember your password? `}</span>
                        <span className="font-['DM_Sans:SemiBold',sans-serif] font-semibold leading-[22.4px] text-[var(--accent-primary)]" style={{ fontVariationSettings: "'opsz' 14" }}>
                          Sign In
                        </span>
                      </p>
                    </div>
