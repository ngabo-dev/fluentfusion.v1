...
function NavAvatar({ initials }: { initials: string }) {
  return (
    <div className="content-stretch flex items-center justify-center pb-[5.91px] pt-[5.09px] relative rounded-[16px] shrink-0 size-[32px]" style={{ backgroundImage: "linear-gradient(135deg, rgb(191, 255, 0) 0%, rgb(143, 239, 0) 100%)" }}>
...
function NavNav({ initials, onLogoClick }: { initials: string; onLogoClick: () => void }) {
  return (
    <div className="backdrop-blur-[8px] bg-[rgba(10,10,10,0.95)] h-[66px] shrink-0 sticky top-0 w-full z-[2]">
        ...
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[11px] items-center pb-[10.89px] pl-[26px] pr-[24px] pt-[10.5px] relative w-full">
          <div className="relative shrink-0">
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative">
              <div className={`flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[14px] text-left whitespace-nowrap ${active ? 'text-[#bfff00]' : 'text-[#888]'}`}>
                <p className="leading-[22.4px]">{icon}</p>
              </div>
            </div>
          </div>
          <div className={`flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[14px] text-left whitespace-nowrap ${active ? 'text-[#bfff00]' : 'text-[#888]'}`} style={{ fontVariationSettings: "'opsz' 14" }}>
...
function AsideSidebar() {
  return (
    <div className="absolute bg-[#0f0f0f] h-[834px] left-0 top-0 w-[240px]">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
        <div className="flex flex-col font-['Syne:ExtraBold',sans-serif] font-extrabold justify-center leading-[0] relative shrink-0 text-[0px] text-white tracking-[-0.64px] uppercase w-full">
          <p className="text-[32px] whitespace-pre-wrap">
            <span className="leading-[51.2px] text-white">Listening </span>
...
function AudioPlayer() {
  return (
    <div className="absolute border border-[rgba(0,207,255,0.15)] border-solid h-[352.38px] left-0 right-0 rounded-[20px] top-0" style={{ backgroundImage: "linear-gradient(134.921deg, rgba(0, 207, 255, 0.06) 0%, rgba(0, 207, 255, 0.02) 100%)" }}>
      <div className="absolute content-stretch flex flex-col items-center left-[36px] right-[36px] top-[36px]">
        <div className="flex flex-col font-['JetBrains_Mono:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#00cfff] text-[10px] text-center tracking-[1.5px] uppercase whitespace-nowrap">
          <p className="leading-[16px]">Listen & Type · Exercise 3</p>
        </div>
      </div>
      <div className="-translate-x-1/2 absolute bg-[#00cfff] content-stretch flex items-center justify-center left-1/2 pb-[18.41px] pt-[16.59px] rounded-[40px] shadow-[0px_0px_20px_0px_rgba(0,207,255,0.3)] size-[80px] top-[72px] cursor-pointer">
        <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[28px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 9" }}>
          <p className="leading-[44.8px]">▶</p>
        </div>
      </div>
      <div className="absolute bg-[#151515] content-stretch flex gap-[3px] h-[64px] items-center left-[36px] overflow-clip px-[20px] right-[36px] rounded-[14px] top-[172px]">
        {[20,36,28,48,32,40,24,44,18,52,30,42].map((h, i) => (
          <div key={i} className={`${i < 6 ? 'bg-[#00cfff]' : 'bg-[#333]'} ${i < 6 ? 'opacity-90' : 'opacity-60'} h-[${h}px] rounded-[2px] shrink-0 w-[3px]`} />
        ))}
      </div>
      <div className="absolute content-stretch flex flex-col items-center left-[36px] right-[36px] top-[247px]">
        <div className="flex flex-col font-['JetBrains_Mono:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#888] text-[12px] text-center whitespace-nowrap">
      ...
      <div className="absolute content-stretch flex gap-[8px] items-start justify-center left-[36px] right-[36px] top-[283.19px]">
        {['0.75×', '1×', '1.25×', '1.5×'].map((speed, i) => (
          <div key={i} className={`content-stretch flex flex-col items-center pb-[6.19px] pt-[5px] px-[13px] relative rounded-[6px] self-stretch shrink-0 cursor-pointer ${i === 1 ? 'bg-[rgba(191,255,0,0.1)]' : 'bg-[#1f1f1f]'}`}>
            <div aria-hidden="true" className={`absolute border border-solid inset-0 pointer-events-none rounded-[6px] ${i === 1 ? 'border-[#bfff00]' : 'border-[#2a2a2a]'}`} />
            <div className={`flex flex-col font-['DM_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[12px] text-center whitespace-nowrap ${i === 1 ? 'text-[#bfff00]' : 'text-[#888]'}`} style={{ fontVariationSettings: "'opsz' 14" }}>
...
function InputArea() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-start left-0 pb-[7px] right-0 top-[376.37px]">
      ...
      <div className="bg-[#1f1f1f] min-h-[80px] relative rounded-[14px] shrink-0 w-full">
          ...
          <div className="content-stretch flex items-start justify-center min-h-[inherit] pb-[41px] pt-[18px] px-[22px] relative w-full">
            <div className="flex-[1_0_0] min-h-px min-w-px relative">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
                <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#757575] text-[16px] w-full" style={{ fontVariationSettings: "'opsz' 9" }}>
  ...
  return (
    <>
      ...
      <div className="absolute content-start flex flex-wrap gap-[0px_8px] items-start left-0 right-0 top-[542.56px]">
        {hints.map((hint, i) => (
          <div key={i} className={`bg-[#151515] content-stretch flex flex-col h-[13.8px] items-start pb-[7.8px] pt-[6px] px-[15px] relative rounded-[8px] shrink-0 cursor-pointer ${i === 1 ? 'opacity-40' : ''}`}>
...
function ActionButtons() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-start left-0 right-0 top-[593.36px]">
      <div className="bg-[#bfff00] content-stretch flex items-center justify-center px-[24px] py-[12px] relative rounded-[8px] shadow-[0px_0px_12px_0px_rgba(191,255,0,0.25)] shrink-0 cursor-pointer">
...
export default function Component18ListeningPractice() {
  ...
  return (
    <div className="bg-[#0a0a0a] content-stretch flex flex-col isolate items-start relative size-full">
      <DivScreenId />
